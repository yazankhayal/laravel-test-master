                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" method="POST" action="{{ route('contacts.update', $contact) }}">
                            ...
                            @if($contact->ContactAddress->count() !=0 )
                                @php $count = 0 ; @endphp
                                @foreach($contact->ContactAddress as $value)
                                    <div class="form-group element" id="address_{{$count}}">
                                        <label for="first_name" class="col-md-4 control-label">Post Code</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control" id="post_code_0" name="post_code[]"
